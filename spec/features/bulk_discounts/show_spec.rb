...
describe 'merchant bulk discount show page' do
  ...
  it 'has discount and threshold' do
    expect(page).to have_content("Percent: #{@bulk_1.percent}")
    expect(page).to have_content("Item Threshold: #{@bulk_1.threshold}")
  end

  it 'has link to edit discount, when clicked I am taken to an edit page' do
